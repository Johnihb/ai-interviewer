  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ willChange: 'transform', border: '3px solid white', borderRight: 'none', borderBottom: 'none' }}
      />
      <div
        ...
        style={{ willChange: 'transform', border: '3px solid white', borderLeft: 'none', borderBottom: 'none' }}
      />
      <div
        ...
        style={{ willChange: 'transform', border: '3px solid white', borderLeft: 'none', borderTop: 'none' }}
      />
      <div
        ...
        style={{ willChange: 'transform', border: '3px solid white', borderRight: 'none', borderTop: 'none' }}
      />
    </div>
  );
};
